 ...
 * @author Christopher A. Sesugh
 * @notice This contract is for creating an untemperable smart contract
...
abstract contract Raffle is VRFConsumerBaseV2, AutomationCompatible {
    ...
    /**
     * @dev This is the function that the Chainlink nodes keeper call
    ...
    function fulfillRandomWords(
        ...
        uint256 indedOfWinner = randomWords[0] % s_players.length;
        address payable recentWinner = s_players[indedOfWinner];
